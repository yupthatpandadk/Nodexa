...
export default createGlobalStyle`
    ...
    :root { --nodexa-user-accent:#4f8cff; --nodexa-bg1:#13283b; --nodexa-bg2:#10263a; --nodexa-bg3:#0c2032; }
    :root[data-nodexa-theme='midnight'] { --nodexa-bg1:#111827; --nodexa-bg2:#0b1220; --nodexa-bg3:#070c15; }
    :root[data-nodexa-theme='slate'] { --nodexa-bg1:#263544; --nodexa-bg2:#1e2d3b; --nodexa-bg3:#172532; }
    body {
        ...
        background:
          ...
          linear-gradient(180deg, var(--nodexa-bg1) 0%, var(--nodexa-bg2) 38%, var(--nodexa-bg3) 100%);
    ...
    ::selection{background:var(--nodexa-user-accent);color:white}
