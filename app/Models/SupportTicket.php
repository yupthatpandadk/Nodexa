...
class SupportTicket extends Model {
 ...
 protected $fillable=['ticket_number','user_id','assigned_to','server_id','subject','department','priority','status','tags','last_reply_at','first_response_at','due_at','closed_at'];
 protected $casts=['last_reply_at'=>'datetime','first_response_at'=>'datetime','due_at'=>'datetime','closed_at'=>'datetime'];
