...
Route::get('/addons/{addon}', [Admin\AddonController::class, 'show'])->name('admin.addons.show');
...
Route::group(['prefix' => 'nodes'], function () {
    ...
    Route::get('/view/{node:id}/health', [Admin\NodesController::class, 'health'])->name('admin.nodes.health');
