...
export default ({ embedded = false }: MinecraftPlayerListProps) => {
    ...
    useEffect(() => { loadMaxPlayers(); }, [loadMaxPlayers]);
    ...
    const command = (action: 'op' | 'deop' | 'whitelist add', player: string) => {
