...
Route::get('/servers/{server}/databases',[ServerDatabaseController::class,'index']);Route::post('/servers/{server}/databases',[ServerDatabaseController::class,'store']);Route::get('/servers/{server}/databases/{database}/credentials',[ServerDatabaseController::class,'credentials']);Route::post('/servers/{server}/databases/{database}/open',[ServerDatabaseController::class,'openPhpMyAdmin']);Route::delete('/servers/{server}/databases/{database}',[ServerDatabaseController::class,'destroy']);
...
Route::get('/system/issues',[SystemIssueController::class,'index']);Route::post('/system/issues/{issue}/resolve',[SystemIssueController::class,'resolve']);Route::post('/system/issues/{issue}/reopen',[SystemIssueController::class,'reopen']);
