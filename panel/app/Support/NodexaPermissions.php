...
final class NodexaPermissions
{
    public const PERMISSIONS = [
        ...
        'admin.discord-bot.view' => 'Se Discord Bot',
        'admin.discord-bot.manage' => 'Administrer Discord Bot',
        'admin.users.view' => 'Se brugere',
        'admin.users.manage' => 'Administrer brugere',
        'admin.roles.view' => 'Se roller og permissions',
        'admin.roles.manage' => 'Administrer roller og permissions',
